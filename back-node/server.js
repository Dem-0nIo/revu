...
const corsOptions = {
  origin: "http://127.0.0.1:3000", // Asegúrate de usar el dominio correcto
  ...
  credentials: true, // Habilitar credenciales (cookies, cabeceras, etc.)
};

app.options("*", cors(corsOptions)); // Permite solicitudes preflight
...
require("./app/routes/influ.routes");
require("./app/routes/cotizaciones.routes");
